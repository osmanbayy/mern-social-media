          ...
          >
            ...
            <div className="flex flex-col items-center pt-8 pb-6 px-6 bg-gradient-to-br from-error/10 via-error/5 to-transparent border-b border-base-300/30">
              <div className="w-16 h-16 rounded-full bg-error/20 flex items-center justify-center mb-4 ring-4 ring-error/10">
                <GoBlockedIcon className="w-8 h-8 text-error" />
              </div>
              <h3 className="font-bold text-xl text-base-content mb-2">Kullanıcıyı Engelle</h3>
              <p className="text-sm text-base-content/70 text-center">
                @{userName} kullanıcısını engellemek istediğinden emin misin?
              </p>
            </div>
            ...
            <div className="px-6 py-6">
              <p className="text-base text-base-content/80 text-center mb-6">
                Bu kullanıcıyı engellediğinde, senin gönderilerini, yorumlarını ve hikayelerini göremeyecek. Sen ise bu kullanıcının profilini görebilirsin ancak gönderilerini göremezsin.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="btn btn-error flex-1 text-white hover:bg-error/90 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
                  disabled={isBlocking}
                >
                  {isBlocking ? (
                    ...
                    <>
                      <GoBlockedIcon className="w-4 h-4 mr-2" />
                      Engelle
                    </>
                  )}
                </button>
