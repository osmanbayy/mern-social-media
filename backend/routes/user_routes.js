...
import { get_user_profile, get_user_by_id_summary, follow_unfollow_user, get_suggested_users, update_user_profile, get_followers, get_following, search_users, search_users_paginated, block_user, unblock_user, get_blocked_users } from "../controllers/user_controller.js";

const router = express.Router();

router.get("/by-id/:id", protect_route, get_user_by_id_summary);
